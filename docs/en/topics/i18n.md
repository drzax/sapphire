...
to the translator.
 * **$array::** (optional) An array of variables for injection into the second parameter
...
#### In Template Files
	...
	:::ss
	// $Name must be available in the current template-scope
	<%t Namespace.Entity "Hello {name} {greeting}" name=$Name greeting="good to see you" %>
